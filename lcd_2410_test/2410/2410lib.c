...
void Port_Init(void)
{
	...
	rGPFDAT=rGPFDAT&0xef;//PF4=0
	rGPFDAT=rGPFDAT&0xdf;//PF5=0
	rGPFDAT=rGPFDAT&0xbf;//PF6=0  保护步进电机
    //=== PORT G GROUP
    ...
    rGPGCON = (rGPGCON & 0xfff3fcff) | (1<<8);	//GPG9 input
    rGPGDAT = (rGPGDAT & 0xffef);
